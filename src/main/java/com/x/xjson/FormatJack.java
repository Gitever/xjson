...
public class FormatJack {
	public static void main(String[] args) {
        ...
        String xml = "<Province xmlns=\"\"><name>Shanxi</name><population>37751200</population><time>2016/12/03 12:12:50</time></Province>";
        Province p2 = JsonUtil.xmlToObj(xml, Province.class);
